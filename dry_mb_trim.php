<?php
/**
 * Devious Concepts - Multibyte Trim Functions (DRY version)
 * ----------------
...
if (extension_loaded('mbstring')) {
    /**
     * mb_trim_charlist_convert
     * 
     * Anonymous function for DRY purposes.
     * 
     ...
     * @return string The PREG-compatible charlist.
     */
    $mb_trim_charlist_convert = function($charlist = NULL, $encoding = NULL) {
        if ($encoding === NULL) {
    ...
    function mb_trim($str, $charlist = NULL, $encoding = NULL) {
        return mb_ltrim(mb_rtrim($str, $charlist, $encoding), $charlist, $encoding);
    }
    /**
     * mb_ltrim
     * 
    ...
    function mb_ltrim($str, $charlist = NULL, $encoding = NULL) {
        $pattern = '/(^[' . $mb_trim_charlist_convert($charlist, $encoding) . ']+)/u'; // Define the pattern.
    ...
    /**
     * Unset $mb_trim_charlist_convert.
     */
    unset($mb_trim_charlist_convert);
} else {
